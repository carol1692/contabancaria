...
public class Cores {
//	Reset Color
	public static final String TEXT_RESET = "\u001B[30m";
...
//	Text Color High Intensity
	public static final String TEXT_BLACK_BRIGHT = "\033[4;30m";
	public static final String TEXT_RED_BRIGHT = "\033[4;31m";
	public static final String TEXT_GREEN_BRIGHT = "\033[4;32m";
	public static final String TEXT_YELLOW_BRIGHT = "\033[4;33m";
	public static final String TEXT_BLUE_BRIGHT = "\033[4;34m";
	public static final String TEXT_PURPLE_BRIGHT = "\033[4;35m";
	public static final String TEXT_CYAN_BRIGHT = "\033[4;36m";
	public static final String TEXT_WHITE_BRIGHT = "\033[4;37m";
	
//	Text Color Bold High Intensity
	public static final String TEXT_BLACK_BOLD_BRIGHT = "\033[4;90m";
	public static final String TEXT_RED_BOLD_BRIGHT = "\033[4;91m";
	public static final String TEXT_GREEN_BOLD_BRIGHT = "\033[4;92m";
	public static final String TEXT_YELLOW_BOLD_BRIGHT = "\033[4;93m";
	public static final String TEXT_BLUE_BOLD_BRIGHT = "\033[4;94m";
	public static final String TEXT_PURPLE_BOLD_BRIGHT = "\033[4;95m";
	public static final String TEXT_CYAN_BOLD_BRIGHT = "\033[4;96m";
	public static final String TEXT_WHITE_BOLD_BRIGHT = "\033[4;97m";
